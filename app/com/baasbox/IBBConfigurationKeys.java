...
public interface IBBConfigurationKeys {
	...
	public static final String WWW_ENABLE = "www.enable";
	public static final String WWW_PATH = "www.path";
	public static final String WWW_INDEX_FILES = "www.index_files";
