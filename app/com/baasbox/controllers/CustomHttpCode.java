...
public enum CustomHttpCode {
			...
			PUSH_BADGE_FORMAT_INVALID(40023,400,"Badge value MUST be a number","error"),
			PUSH_ACTION_LOCALIZED_KEY_FORMAT_INVALID(40024,400,"actionLocalizedKey MUST be a String","error"),
			PUSH_LOCALIZED_KEY_FORMAT_INVALID(40025,400,"LocalizedKey MUST be a String","error"),
			PUSH_LOCALIZED_ARGUMENTS_FORMAT_INVALID(40026,400,"LocalizedArguments MUST be ad Array of String","error"),
			PUSH_COLLAPSE_KEY_FORMAT_INVALID(40027,400,"collapse_key MUST be a String","error"),
			PUSH_TIME_TO_LIVE_FORMAT_INVALID(40028,400,"time_to_live MUST be a positive number or equal zero","error"),
