...
public enum CustomHttpCode {
			...
			PUSH_INVALID_APIKEY (50303,503,"Could not save API KEY. HINT: Check your API Key, it's possible that push service aren't enabled in the Google Play Developer Console","error"),
			PUSH_PROFILE_DISABLED(50304,503,"Push profile disabled, one or more profile are disabled","error"),
			PUSH_SWITCH_EXCEPTION(50305,503,"Cannot switch, because settings for the selected mode are missing","error"),
