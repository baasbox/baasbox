...
public enum CustomHttpCode {
			...
			PUSH_PROFILE_INVALID(40020,400,"Push profile invalid. It must be an Array of integer and accepted values are 1,2 or 3","error"),
			PUSH_PROFILE_ARRAY_EXCEPTION(40021,400,"Push profile array too big. Max three values are accepted","error"),
			PUSH_USERS_ARRAY_EXCEPTION(40022,400,"Users MUST be an array of String","error"),
			...
			PUSH_MESSAGE_FORMAT_INVALID(40031,400,"Message MUST be a String","error"),
