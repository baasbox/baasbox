...
public class JSONFormats {
	...
	public enum Formats{
		USER("fetchPlan:user.password:-2 user.roles.name:1 user.roles.inheritedRole:-2 user.roles.rules:-2 user.roles:0 _creation_date:-2 visibleByAnonymousUsers:1 visibleByTheUser:1 visibleByFriend:1 visibleByRegisteredUsers:1 _links:-2 _audit:-2 system:-2 _allow:-2 _allowRead:-2,indent:0"),
		JSON("fetchPlan:user.password:-2 user.status:-2 user.roles:-1 user.roles.mode:-2 user.roles.inheritedRole:-2 user.roles.name:1 user.roles.rules:-2 visibleByTheUser:1 visibleByFriend:1 visibleByRegisteredUsers:1 system:-2 _links:-2 _audit:-2 _allow:-2,indent:0"),
		...
		FILE("fetchPlan:resized:-2 audit:0 _links:0 _allow:0 _allowread:0 _allowwrite:0 _allowUpdate:0 _allowDelete:0 file:0,rid,version,class,attribSameRow,indent:0"),
