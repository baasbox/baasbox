...
public class JSONFormats {
	...
	public enum Formats{
		USER("fetchPlan:user:1 user.roles:1 user.roles.rules:-2 visibleByAnonymousUsers:1 visibleByTheUser:1 visibleByFriend:1 visibleByRegisteredUsers:1,indent:0"),
