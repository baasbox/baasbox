...
public enum DefaultRoles {
	...
	BACKOFFICE_USER	("backoffice","writer","Preconfigured role to give users belonging to it to access the contents generated by the registered users",true,false),
